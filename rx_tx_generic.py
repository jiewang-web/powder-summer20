...
def rx(tx_name, rx_connection_list, rx_names_list):
    ...
    for connection in rx_connection_list:
        ...
        if rx_names_list[connect_index] == 'Browning':
            ...
            subprocess.call('pscp -pw kirby -scp alliet@pc775.emulab.net:~/brown_bin_db_power.csv brown_bin_db_power.csv')
            ...
            subprocess.call('pscp -pw kirby -scp alliet@pc761.emulab.net:~/bes_bin_db_power.csv bes_bin_db_power.csv')
            ...
            subprocess.call('pscp -pw kirby -scp alliet@pc765.emulab.net:~/fm_bin_db_power.csv fm_bin_db_power.csv')
            ...
            subprocess.call('pscp -pw kirby -scp alliet@pc768.emulab.net:~/meb_bin_db_power.csv meb_bin_db_power.csv')
            ...
            subprocess.call('pscp -pw kirby -scp alliet@pc772.emulab.net:~/ustar_bin_db_power.csv ustar_bin_db_power.csv')
            ...
            subprocess.call('pscp -pw kirby -scp alliet@pc776.emulab.net:~/honors_bin_db_power.csv honors_bin_db_power.csv')
            ...
            subprocess.call('pscp -pw kirby -scp alliet@pc770.emulab.net:~/smt_bin_db_power.csv smt_bin_db_power.csv')
            ...
            subprocess.call('pscp -pw kirby -scp alliet@pc780.emulab.net:~/den_bin_db_power.csv den_bin_db_power.csv')
...
def rx_tx_decision():
    ...
    brown = Connection(host = 'pc775.emulab.net', user = 'alliet',
        connect_kwargs={'key_filename': '/Users/allis/Powder/paramiko/id_rsa'})
    all_connections.append(brown)

    bes = Connection(host = 'pc761.emulab.net', user = 'alliet',
        connect_kwargs={'key_filename': '/Users/allis/Powder/paramiko/id_rsa'})
    all_connections.append(bes)

    meb = Connection(host = 'pc768.emulab.net', user = 'alliet',
        connect_kwargs={'key_filename': '/Users/allis/Powder/paramiko/id_rsa'})
    all_connections.append(meb)

    ustar = Connection(host = 'pc772.emulab.net', user = 'alliet',
        connect_kwargs={'key_filename': '/Users/allis/Powder/paramiko/id_rsa'})
    all_connections.append(ustar)

    fm = Connection(host = 'pc765.emulab.net', user = 'alliet',
        connect_kwargs={'key_filename': '/Users/allis/Powder/paramiko/id_rsa'})
    all_connections.append(fm)

    den = Connection(host = 'pc780.emulab.net', user = 'alliet',
        connect_kwargs={'key_filename': '/Users/allis/Powder/paramiko/id_rsa'})
    all_connections.append(den)

    honors = Connection(host = 'pc776.emulab.net', user = 'alliet',
        connect_kwargs={'key_filename': '/Users/allis/Powder/paramiko/id_rsa'})
    all_connections.append(honors)

    smt = Connection(host = 'pc770.emulab.net', user = 'alliet',
        connect_kwargs={'key_filename': '/Users/allis/Powder/paramiko/id_rsa'})
